...
class RRTBase_Q(object):
    ...
    def linear_sampling_collision_check(self,start,goal):
        ...
        range_q3 = abs(start[2] - goal[2])
        d = math.sqrt(range_q1 ** 2 + range_q2 ** 2 + range_q3 ** 2)  # prepona
        ...
        for i in range(1,samples):
            ...
            if start[2] < goal[2]: q3 = start[2] + i*increment_z
            else: q3 = start[2] - i*increment_z
